...
/**
 * The Sack is a collection data structure.
 * Items must be added to a Sack before it can be  used.
 * When a Sack is loaded items can be removed.
 * Items are removed in random order.
 * During the remove phase items cannot be added to a Sack.
 * The remove phase ends when the Sack is empty.
 * 
 * @author Ian Bradley 
 * @version 1.0
 */
